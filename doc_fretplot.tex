...
The sister project \href{https://github.com/8vasu/fretplot-mcp}{\texttt{fretplot-mcp}} implements a Model Context Protocol (MCP) server that allows MCP clients to generate fretplot-specific code from natural language descriptions of musical scales and chord voicings.\\

The fretplot package was featured in \href{https://publications.gutenberg-asso.fr/lettre/article/view/131}{\textit{La Lettre GUTenberg}}.
